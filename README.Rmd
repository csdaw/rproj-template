...
![Docker Pulls](https://img.shields.io/docker/pulls/csdaw/rproj-template)
![Docker Image Size (tag)](https://img.shields.io/docker/image-size/csdaw/rproj-template/latest)
...
[here](https://hub.docker.com/repository/docker/csdaw/rproj-template) with
